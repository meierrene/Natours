...
const tourSchema = new mongoose.Schema(
  {
    ...
    price: { type: Number, required: [true, 'A price must be specified'] },
    priceDiscount: {
      type: Number,
      validate: {
    ...
    imageCover: {
      type: String,
      required: [true, 'A description must have a cover image'],
    },
    images: [String],
...
tourSchema.virtual('durationWeeks').get(function () {
  // regular NOT arrow function because it contains this. inside
